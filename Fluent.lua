...
[25] = function()
    ...
    function aj.New(c, d)
	 ...
	 function e.SetValue(t, c)  
             e.Frame.Title.Text = t or d.Title  
             e.Frame.Content.Text = c or d.Content  
        end  
        return e
    end
...
function c.New(d, e, f)  
 ...
   h.SetTitle = function(self, title) i.Text = title end  
   h.SetDesc = function(self, desc) i.DescLabel.Text = desc end  
